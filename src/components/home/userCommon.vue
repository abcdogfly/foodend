        ...
        <el-tabs v-model="activeName" >
            <div class="table">
                ...
                <el-table :data="filterdata" border style="width: 100%" ref="multipleTable" size="mini">
                    ...
                    <el-table-column prop="achievement_Year" label="用户名id" ></el-table-column>
                    <el-table-column prop="achievement_Year" label="用户" ></el-table-column>
                    <el-table-column prop="achievement_Year" label="注册时间" ></el-table-column>
                ...
                <el-dialog  title="添加"  :visible.sync="dialogFormVisible" center width="35%" >
                    <el-form class="demo-ruleForm" :model="form" ref="form" :rules="rules"  label-position="left">
                        <el-form-item label="年份"  :label-width="formLabelWidth" prop="day">
                            <el-date-picker
                                v-model="form.day"
                                type="date"
                                placeholder="选择日期">
                        ...
                        <el-form-item label="目标金额 / 万" :label-width="formLabelWidth" prop="money">
